      ...
      content: (
        <div className="space-y-5 text-xs leading-relaxed">
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-slate-600 dark:text-slate-300">
            ...
            <li>{getLoc({ de: 'Das SOCDOF-Startmenü enthält über das Ein/Aus-Symbol jetzt Sperren, Benutzer wechseln, Abmelden, Neustart des Arbeitsbereichs und Schließen der App. Der Benutzerbereich im Startmenü öffnet die Kontoeinstellungen bzw. für Administratoren direkt „Benutzer & Konten“.', en: 'The SOCDOF Start menu power control now provides Lock, Switch user, Sign out, Restart workspace, and Close SOCDOF. The Start menu user area opens account settings or, for administrators, directly opens Users & Accounts.', fr: 'Le contrôle d’alimentation du menu Démarrer de SOCDOF propose désormais Verrouiller, Changer d’utilisateur, Se déconnecter, Redémarrer l’espace de travail et Fermer SOCDOF. La zone utilisateur ouvre les paramètres du compte ou, pour les administrateurs, directement Utilisateurs et comptes.', es: 'El control de energía del menú Inicio de SOCDOF ofrece ahora Bloquear, Cambiar de usuario, Cerrar sesión, Reiniciar el espacio de trabajo y Cerrar SOCDOF. El área de usuario abre la configuración de cuenta o, para administradores, directamente Usuarios y cuentas.' })}</li>
