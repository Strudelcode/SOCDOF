...
export const LanguageSelectionModal: React.FC<LanguageSelectionModalProps> = ({
  ...
  const availableLanguages: LanguageOptionItem[] = useMemo(() => {
    ...
    // 2. Custom language packs from desktop folder (%APPDATA%/socdof/languages/)
    ...
    // 3. Any additional manually imported custom packs
  ...
  const handleOpenFlagsFolder = async () => {
    ...
    try {
      await navigator.clipboard.writeText('%APPDATA%\\socdof\\languages\\flags');
      sounds.playSuccess();
    } catch {}
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Selection Module Controls & Filter */}
        <div className="px-5 sm:px-6 pt-4 pb-2 space-y-3 shrink-0">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Sprache oder Datei suchen / Search language..."
            ...
            <div className="space-y-2">
              {filteredLanguages.length === 0 ? (
                <div className="p-6 text-center text-xs text-slate-400">
                  Keine Sprache gefunden für "{searchQuery}".
                </div>
              ) : (
                filteredLanguages.map((item) => {
            ...
            <div className="p-3 bg-slate-100/70 dark:bg-slate-800/60 rounded-2xl border border-slate-200/80 dark:border-slate-700/60 text-[11px] text-slate-600 dark:text-slate-400 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
              <div className="flex items-center gap-2 min-w-0">
                ...
                <span className="truncate">
                  Live Ordner: <code className="font-mono text-[10px] select-all">%APPDATA%\socdof\languages\</code>
                </span>
              </div>
              <div className="flex items-center gap-2 shrink-0">
                <button
                  ...
                  title="Ordner für eigene Flaggen-Bilder öffnen"
                >
