  ...
  return (
    ...
    >
      <div 
        ...
        className={`w-full max-w-4xl max-h-[92vh] flex flex-col rounded-3xl shadow-2xl border transition-all animate-scale-up overflow-hidden ${
          isDark 
        ...
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-slate-200/80 dark:border-slate-800">
          <div className="flex items-center gap-3 overflow-hidden">
            ...
            <div className="min-w-0">
              <h3 className="text-sm font-bold truncate">{attachment.name}</h3>
