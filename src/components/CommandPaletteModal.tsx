...
export const CommandPaletteModal: React.FC<CommandPaletteModalProps> = ({
  ...
  const allItems: PaletteItem[] = useMemo(() => {
    ...
    const appModules: Array<{ id: ActiveModule; title: string; subtitle: string; icon: any; color: string }> = [
      ...
      { id: 'therapy_practice', title: t('module.therapy_practice', lang, 'Praxis & Therapie'), subtitle: t('desc.therapy_practice', lang, 'Klienten, Sitzungen, Termine, Fahrtenbuch & Abrechnung'), icon: Briefcase, color: 'bg-slate-700' },
      { id: 'calculator', title: t('module.calculator', lang, 'Taschenrechner'), subtitle: t('desc.calculator', lang, 'Einfach & Wissenschaftlich'), icon: Calculator, color: 'bg-emerald-600' },
