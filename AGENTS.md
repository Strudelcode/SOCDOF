...
1. **Language & Documentation**: All development notes, release history entries (`versions/V*.md`), code comments, and project documentation MUST strictly be written in **English**. User-facing UI texts remain multilingual via `src/lib/i18n.ts`.
